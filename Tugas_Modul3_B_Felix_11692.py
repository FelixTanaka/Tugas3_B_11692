...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1692</h1>", unsafe_allow_html=True) 
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\LENOVO\Documents\Semester 5\Pembelajaran mesin dan mendalam\Bagian 3\Tugas3_B_11692'
